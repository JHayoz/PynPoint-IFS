...
# create ticks and tick labels for the X and Y position relative to the star, assuming that North is up and East is left
...
# plot the PSF in image intensity
...
# write the labels of the molecular map
...
# translate the name of a molecule into a nice name
def nice_name(mol):
    if mol=='chem_equ':
        return 'Full model'
    result = ''
...
# upsamples and co-align the intensity images
...
# co-add the already aligned intensity images to make a nice PSF picture
